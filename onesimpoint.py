...
parser.add_argument("--nemu-home", type=str, default="/nfs/home/zhangchuanqi/lvna/for_xs/xs-env/nemu-sdcard-cpt")
...
'-r ./resource/gcpt_restore/build/gcpt-enable-tie.bin ' + \
f'-w {args.workload} ' + \
'--simpoint-profile ' + \
f'{args.bbl} '
...
take_cpt_cmd = f'./build/riscv64-nemu-interpreter \
