...
bool vp_enable();
def_THelper(vload) {
  def_INSTR_TAB("??? ?00 ? 00000 ????? ??? ????? ????? ??", vlduu);
  def_INSTR_TAB("??? ?00 ? 01000 ????? ??? ????? ????? ??", vldr);
  def_INSTR_TAB("??? ?00 ? 01011 ????? ??? ????? ????? ??", vldm);
...
def_THelper(vstore) {
  decode_op_i(s, id_src2, (sword_t)s->isa.instr.i.simm11_0, false);
  decode_op_fr(s, id_dest, s->isa.instr.i.rd, false);
  def_INSTR_TAB("??? ?00 ? 00000 ????? ??? ????? ????? ??", vstu);
  def_INSTR_TAB("??? ?00 ? 01000 ????? ??? ????? ????? ??", vstr);
  def_INSTR_TAB("??? ?00 ? 01011 ????? ??? ????? ????? ??", vstm);
...
def_THelper(vload_mmu) {
  def_INSTR_TAB("??? ?00 ? 00000 ????? ??? ????? ????? ??", vlduu_mmu);
  def_INSTR_TAB("??? ?00 ? 01000 ????? ??? ????? ????? ??", vldr_mmu);
  def_INSTR_TAB("??? ?00 ? 01011 ????? ??? ????? ????? ??", vldm_mmu);
  def_INSTR_TAB("??? ?01 ? ????? ????? ??? ????? ????? ??", vldxu_mmu);
  def_INSTR_TAB("??? ?10 ? ????? ????? ??? ????? ????? ??", vldsu_mmu);
  def_INSTR_TAB("??? ?11 ? ????? ????? ??? ????? ????? ??", vldxu_mmu);
  return EXEC_ID_inv;
}

def_THelper(vstore_mmu) {
  def_INSTR_TAB("??? ?00 ? 00000 ????? ??? ????? ????? ??", vstu_mmu);
  def_INSTR_TAB("??? ?00 ? 01000 ????? ??? ????? ????? ??", vstr_mmu);
  def_INSTR_TAB("??? ?00 ? 01011 ????? ??? ????? ????? ??", vstm_mmu);
  def_INSTR_TAB("??? ?01 ? ????? ????? ??? ????? ????? ??", vstx_mmu);
  def_INSTR_TAB("??? ?10 ? ????? ????? ??? ????? ????? ??", vsts_mmu);
  def_INSTR_TAB("??? ?11 ? ????? ????? ??? ????? ????? ??", vstx_mmu);
  return EXEC_ID_inv;
}
