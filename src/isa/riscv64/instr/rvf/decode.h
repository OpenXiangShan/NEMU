...
bool vp_enable();
def_THelper(vload) {
  def_INSTR_TAB("??? ?00 ? ?0000 ????? ??? ????? ????? ??", vle);
  def_INSTR_TAB("??? ?00 ? 01000 ????? ??? ????? ????? ??", vlr);
  def_INSTR_TAB("??? ?00 ? 01011 ????? ??? ????? ????? ??", vlm);
  def_INSTR_TAB("??? ?01 ? ????? ????? ??? ????? ????? ??", vlxe);
  def_INSTR_TAB("??? ?10 ? ????? ????? ??? ????? ????? ??", vlse);
  def_INSTR_TAB("??? ?11 ? ????? ????? ??? ????? ????? ??", vlxe);
  return EXEC_ID_inv;
}
...
def_THelper(vstore) {
  decode_op_i(s, id_src2, (sword_t)s->isa.instr.i.simm11_0, false);
  decode_op_fr(s, id_dest, s->isa.instr.i.rd, false);
  def_INSTR_TAB("??? ?00 ? 00000 ????? ??? ????? ????? ??", vse);
  def_INSTR_TAB("??? ?00 ? 01000 ????? ??? ????? ????? ??", vsr);
  def_INSTR_TAB("??? ?00 ? 01011 ????? ??? ????? ????? ??", vsm);
  def_INSTR_TAB("??? ?01 ? ????? ????? ??? ????? ????? ??", vsxe);
  def_INSTR_TAB("??? ?10 ? ????? ????? ??? ????? ????? ??", vsse);
  def_INSTR_TAB("??? ?11 ? ????? ????? ??? ????? ????? ??", vsxe);
  return EXEC_ID_inv;
}

def_THelper(vload_mmu) {
  def_INSTR_TAB("??? ?00 ? ?0000 ????? ??? ????? ????? ??", vle_mmu);
  def_INSTR_TAB("??? ?00 ? 01000 ????? ??? ????? ????? ??", vlr_mmu);
  def_INSTR_TAB("??? ?00 ? 01011 ????? ??? ????? ????? ??", vlm_mmu);
  def_INSTR_TAB("??? ?01 ? ????? ????? ??? ????? ????? ??", vlxe_mmu);
  def_INSTR_TAB("??? ?10 ? ????? ????? ??? ????? ????? ??", vlse_mmu);
  def_INSTR_TAB("??? ?11 ? ????? ????? ??? ????? ????? ??", vlxe_mmu);
  return EXEC_ID_inv;
}

def_THelper(vstore_mmu) {
  def_INSTR_TAB("??? ?00 ? 00000 ????? ??? ????? ????? ??", vse_mmu);
  def_INSTR_TAB("??? ?00 ? 01000 ????? ??? ????? ????? ??", vsr_mmu);
  def_INSTR_TAB("??? ?00 ? 01011 ????? ??? ????? ????? ??", vsm_mmu);
  def_INSTR_TAB("??? ?01 ? ????? ????? ??? ????? ????? ??", vsxe_mmu);
  def_INSTR_TAB("??? ?10 ? ????? ????? ??? ????? ????? ??", vsse_mmu);
  def_INSTR_TAB("??? ?11 ? ????? ????? ??? ????? ????? ??", vsxe_mmu);
  return EXEC_ID_inv;
}
