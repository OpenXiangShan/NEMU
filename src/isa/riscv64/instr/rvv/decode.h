...
def_THelper(vfunary1_dispatch) {
    ...
    def_INSTR_TAB("?????? ? ????? 00001 ??? ????? ????? ??", vfexp2_v);
#endif
#ifdef CONFIG_CUSTOM_XVEXP2_BF16
    def_INSTR_TAB("?????? ? ????? 00010 ??? ????? ????? ??", vfexp2bf16_v);
#endif
...
def_THelper(vopmvv) {
  ...
  def_INSTR_TAB("011111 ? ????? ????? ??? ????? ????? ??", vmxnor);
    ...
    // vaesz.vs — single-source (funct6=101001, vs1=00111 encodes the operation)
    def_INSTR_TAB("101001 ? ????? 00111 010 ????? ????? ??", vaesz);
    // vaesef — .vs (funct6=101001) and .vv (funct6=101000), vs1=00011 encodes op
    def_INSTR_TAB("101001 ? ????? 00011 010 ????? ????? ??", vaesef);
    def_INSTR_TAB("101000 ? ????? 00011 010 ????? ????? ??", vaesef);
    // vaesem — .vs (funct6=101001) and .vv (funct6=101000), vs1=00010 encodes op
    def_INSTR_TAB("101001 ? ????? 00010 010 ????? ????? ??", vaesem);
    def_INSTR_TAB("101000 ? ????? 00010 010 ????? ????? ??", vaesem);
    // vaesdf — .vs (funct6=101001) and .vv (funct6=101000), vs1=00001 encodes op
    def_INSTR_TAB("101001 ? ????? 00001 010 ????? ????? ??", vaesdf);
    def_INSTR_TAB("101000 ? ????? 00001 010 ????? ????? ??", vaesdf);
    // vaesdm — .vs (funct6=101001) and .vv (funct6=101000), vs1=00000 encodes op
    def_INSTR_TAB("101001 ? ????? 00000 010 ????? ????? ??", vaesdm);
    def_INSTR_TAB("101000 ? ????? 00000 010 ????? ????? ??", vaesdm);
    // vaeskf1.vi — funct6=100010, vs1 = uimm (free)
    def_INSTR_TAB("100010 ? ????? ????? 010 ????? ????? ??", vaeskf1);
    // vaeskf2.vi — funct6=101010, vs1 = uimm (free)
    def_INSTR_TAB("101010 ? ????? ????? 010 ????? ????? ??", vaeskf2);
  #endif // CONFIG_RV_ZVKNED

  #if defined(CONFIG_RV_ZVKNHA) || defined(CONFIG_RV_ZVKNHB)
    def_INSTR_TAB("101101 1 ????? ????? 010 ????? ????? ??", vsha2ms);
    def_INSTR_TAB("101110 1 ????? ????? 010 ????? ????? ??", vsha2ch);
    def_INSTR_TAB("101111 1 ????? ????? 010 ????? ????? ??", vsha2cl);
  #endif // CONFIG_RV_ZVKNHA || CONFIG_RV_ZVKNHB

  #ifdef CONFIG_RV_ZVKSH
    def_INSTR_TAB("100000 1 ????? ????? 010 ????? ????? ??", vsm3me);
    def_INSTR_TAB("101011 1 ????? ????? 010 ????? ????? ??", vsm3c);
  #endif // CONFIG_RV_ZVKSH

  #ifdef CONFIG_RV_ZVKSED
    def_INSTR_TAB("100001 1 ????? ????? 010 ????? ????? ??", vsm4k);
    def_INSTR_TAB("101000 1 ????? 10000 010 ????? ????? ??", vsm4r);
    def_INSTR_TAB("101001 1 ????? 10000 010 ????? ????? ??", vsm4r);
  #endif // CONFIG_RV_ZVKSED

  #ifdef CONFIG_RV_ZVKG
    def_INSTR_TAB("101100 1 ????? ????? 010 ????? ????? ??", vghsh);
    def_INSTR_TAB("101000 1 ????? 10001 010 ????? ????? ??", vgmul);
  ...
  def_INSTR_TAB("100111 ? ????? ????? ??? ????? ????? ??", vmulh);
    ...
    def_INSTR_TAB("001100 ? ????? ????? ??? ????? ????? ??", vclmul);
    def_INSTR_TAB("001101 ? ????? ????? ??? ????? ????? ??", vclmulh);
...
def_THelper(vopfvv) {
  ...
  def_INSTR_TAB("111011 ? ????? ????? ??? ????? ????? ??", vfwmaccbf16);
#endif
