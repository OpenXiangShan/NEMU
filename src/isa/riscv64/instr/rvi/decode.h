...
def_THelper(op_imm) {
  ...
  def_INSTR_TAB("0000000 00000 00000 000 ????? ????? ??", p_li_0);
  def_INSTR_TAB("0000000 00001 00000 000 ????? ????? ??", p_li_1);
  def_INSTR_TAB("??????? ????? 00000 000 ????? ????? ??", c_li);
  def_INSTR_TAB("0000000 00000 ????? 000 ????? ????? ??", c_mv);
