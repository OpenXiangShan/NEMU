...
def_THelper(op_imm) {
  ...
  def_INSTR_TAB("??????? ????? ????? 110 ????? ????? ??", nemuori);
  def_INSTR_TAB("??????? ????? ????? 111 ????? ????? ??", nemuandi);
...
def_THelper(op) {
  if (s->isa.instr.r.rd == s->isa.instr.r.rs1) {
    ...
    def_INSTR_TAB("0000000 ????? ????? 110 ????? ????? ??", c_nemuor);
    def_INSTR_TAB("0000000 ????? ????? 111 ????? ????? ??", c_nemuand);
  }
  def_INSTR_TAB("0000000 ????? ????? 000 ????? ????? ??", add);
  def_INSTR_TAB("0000000 ????? ????? 001 ????? ????? ??", sll);
  def_INSTR_TAB("0000000 ????? ????? 010 ????? ????? ??", slt);
  def_INSTR_TAB("0000000 ????? ????? 011 ????? ????? ??", sltu);
  def_INSTR_TAB("0000000 ????? ????? 100 ????? ????? ??", nemuxor);
  def_INSTR_TAB("0000000 ????? ????? 101 ????? ????? ??", srl);
  def_INSTR_TAB("0000000 ????? ????? 110 ????? ????? ??", nemuor);
  def_INSTR_TAB("0000000 ????? ????? 111 ????? ????? ??", nemuand);
