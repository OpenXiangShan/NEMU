...
static inline void matmul_accum_kernel(
    void *input0, void *input1, void *output, int input0_dim0, int input0_dim1,
    int input1_dim0, int input1_dim1, int input0_stride0, int input0_stride1,
    int input1_stride0, int input1_stride1, int output_stride0,
    int output_stride1, float (*convert0)(void *, int),
...
// ======================================
// FP32 Output Kernels (9 variants)
// ======================================
...
void matmul_fp32_fp16_fp16(void *input0, void *input1, void *output,
                           ...
                           int output_stride1) {
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_fp16, load_fp16, load_fp32,
                      store_fp32);
}
...
void matmul_fp32_fp16_bf16(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_fp16, load_bf16, load_fp32,
                      store_fp32);
}
...
void matmul_fp32_fp16_tf32(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_fp16, load_tf32, load_fp32,
                      store_fp32);
}
...
void matmul_fp32_bf16_fp16(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_bf16, load_fp16, load_fp32,
                      store_fp32);
}
...
void matmul_fp32_bf16_bf16(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_bf16, load_bf16, load_fp32,
                      store_fp32);
}
...
void matmul_fp32_bf16_tf32(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_bf16, load_tf32, load_fp32,
                      store_fp32);
}
...
void matmul_fp32_tf32_fp16(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_tf32, load_fp16, load_fp32,
                      store_fp32);
}
...
void matmul_fp32_tf32_bf16(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_tf32, load_bf16, load_fp32,
                      store_fp32);
}
...
void matmul_fp32_tf32_tf32(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_tf32, load_tf32, load_fp32,
                      store_fp32);
}
...
void matmul_fp32_fp32_fp32(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_fp32, load_fp32, load_fp32,
                      store_fp32);
}

// ======================================
// FP16 Output Kernels (9 variants)
// ======================================
...
void matmul_fp16_fp16_fp16(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_fp16, load_fp16, load_fp16,
                      store_fp16);
}
...
void matmul_fp16_fp16_bf16(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_fp16, load_bf16, load_fp16,
                      store_fp16);
}
...
void matmul_fp16_fp16_tf32(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_fp16, load_tf32, load_fp16,
                      store_fp16);
}
...
void matmul_fp16_bf16_fp16(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_bf16, load_fp16, load_fp16,
                      store_fp16);
}
...
void matmul_fp16_bf16_bf16(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_bf16, load_bf16, load_fp16,
                      store_fp16);
}
...
void matmul_fp16_bf16_tf32(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_bf16, load_tf32, load_fp16,
                      store_fp16);
}
...
void matmul_fp16_tf32_fp16(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_tf32, load_fp16, load_fp16,
                      store_fp16);
}
...
void matmul_fp16_tf32_bf16(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_tf32, load_bf16, load_fp16,
                      store_fp16);
}
...
void matmul_fp16_tf32_tf32(void *input0, void *input1, void *output,
  ...
  matmul_accum_kernel(input0, input1, output, input0_dim0, input0_dim1,
                      input1_dim0, input1_dim1, input0_stride0, input0_stride1,
                      input1_stride0, input1_stride1, output_stride0,
                      output_stride1, load_tf32, load_tf32, load_fp16,
                      store_fp16);
}
...
int matmul_s16_s8_s8(void *input0, void *input1, void *output,
    ...
    for (int i = 0; i < input0_dim0; i++) {
        for (int j = 0; j < input1_dim1; j++) {
            int16_t sum = 0;
            for (int k = 0; k < input0_dim1; k++) {
                sum += (int16_t)(((int8_t *)input0)[i * input0_stride0 + k * input0_stride1]) * 
                       (int16_t)(((int8_t *)input1)[k * input1_stride0 + j * input1_stride1]);
            }
...
int matmul_s32_s8_s8(void *input0, void *input1, void *output,
    ...
    for (int i = 0; i < input0_dim0; i++) {
        for (int j = 0; j < input1_dim1; j++) {
            int32_t sum = 0;
            for (int k = 0; k < input0_dim1; k++) {
                sum += (int32_t)(((int8_t *)input0)[i * input0_stride0 + k * input0_stride1]) * 
                       (int32_t)(((int8_t *)input1)[k * input1_stride0 + j * input1_stride1]);
            }
...
int matmul_s32_u8_u8(void *input0, void *input1, void *output,
    ...
    for (int i = 0; i < input0_dim0; i++) {
        for (int j = 0; j < input1_dim1; j++) {
            int32_t sum = 0;
            for (int k = 0; k < input0_dim1; k++) {
                sum += (int32_t)(((uint8_t *)input0)[i * input0_stride0 + k * input0_stride1]) * 
                       (int32_t)(((uint8_t *)input1)[k * input1_stride0 + j * input1_stride1]);
            }
            ((int32_t *)output)[i * output_stride0 + j * output_stride1] += sum;
        }
    }
...
int matmul_s16_u8_u8(void *input0, void *input1, void *output,
    ...
    for (int i = 0; i < input0_dim0; i++) {
        for (int j = 0; j < input1_dim1; j++) {
            int16_t sum = 0;
            for (int k = 0; k < input0_dim1; k++) {
                sum += (int16_t)(((uint8_t *)input0)[i * input0_stride0 + k * input0_stride1]) * 
                       (int16_t)(((uint8_t *)input1)[k * input1_stride0 + j * input1_stride1]);
            }
            ((int16_t *)output)[i * output_stride0 + j * output_stride1] += sum;
        }
    }
