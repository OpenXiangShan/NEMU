...
// ======================= CORE KERNEL =======================
static inline void
matmul_accum_kernel(void *input0, void *input1, void *output, int input0_dim0,
                    int input0_dim1, int input1_dim0, int input1_dim1,
                    int input0_stride0, int input0_stride1, int input1_stride0,
                    int input1_stride1, int output_stride0, int output_stride1,
                    convert_func_t convert0, convert_func_t convert1,
                    load_func_t load_output, store_func_t store_output) {
...
// ======================= KERNEL DECLARATIONS =======================
#define DECLARE_KERNEL(in0_type, in1_type, out_type)                           \
  void matmul_##out_type##_##in0_type##_##in1_type(                            \
      void *i0, void *i1, void *o, int input0_dim0, int input0_dim1,           \
      int input1_dim0, int input1_dim1, int input0_stride0,                    \
      int input0_stride1, int input1_stride0, int input1_stride1,              \
      int output_stride0, int output_stride1) {                                \
    matmul_accum_kernel(                                                       \
        i0, i1, o, input0_dim0, input0_dim1, input1_dim0, input1_dim1,         \
        input0_stride0, input0_stride1, input1_stride0, input1_stride1,        \
        output_stride0, output_stride1, convert_##in0_type,                    \
        convert_##in1_type, load_##out_type, store_##out_type);                \
  }

DECLARE_KERNEL(ue1m7, ue1m7, fp32)
DECLARE_KERNEL(ue1m7, ue1m7, fp16)
DECLARE_KERNEL(e1m6, e1m6, fp32)
DECLARE_KERNEL(e1m6, e1m6, fp16)
DECLARE_KERNEL(e1m5, e1m5, fp32)
DECLARE_KERNEL(e1m5, e1m5, fp16)
DECLARE_KERNEL(e1m4, e1m4, fp32)
DECLARE_KERNEL(e1m4, e1m4, fp16)
DECLARE_KERNEL(e1m3, e1m3, fp32)
DECLARE_KERNEL(e1m3, e1m3, fp16)
DECLARE_KERNEL(e1m2, e1m2, fp32)
DECLARE_KERNEL(e1m2, e1m2, fp16)
DECLARE_KERNEL(e1m1, e1m1, fp32)
DECLARE_KERNEL(e1m1, e1m1, fp16)
DECLARE_KERNEL(e1m0, e1m0, fp32)
DECLARE_KERNEL(e1m0, e1m0, fp16)
DECLARE_KERNEL(ue1m6, ue1m6, fp32)
DECLARE_KERNEL(ue1m6, ue1m6, fp16)
DECLARE_KERNEL(ue2m6, ue2m6, fp32)
DECLARE_KERNEL(ue2m6, ue2m6, fp16)
DECLARE_KERNEL(e2m5, e2m5, fp32)
DECLARE_KERNEL(e2m5, e2m5, fp16)
DECLARE_KERNEL(e2m4, e2m4, fp32)
DECLARE_KERNEL(e2m4, e2m4, fp16)
DECLARE_KERNEL(e2m3, e2m3, fp32)
DECLARE_KERNEL(e2m3, e2m3, fp16)
DECLARE_KERNEL(e2m2, e2m2, fp32)
DECLARE_KERNEL(e2m2, e2m2, fp16)
DECLARE_KERNEL(e2m1, e2m1, fp32)
DECLARE_KERNEL(e2m1, e2m1, fp16)
DECLARE_KERNEL(e2m0, e2m0, fp32)
DECLARE_KERNEL(e2m0, e2m0, fp16)
DECLARE_KERNEL(ue1m5, ue1m5, fp32)
DECLARE_KERNEL(ue1m5, ue1m5, fp16)
DECLARE_KERNEL(ue2m5, ue2m5, fp32)
DECLARE_KERNEL(ue2m5, ue2m5, fp16)
DECLARE_KERNEL(ue3m5, ue3m5, fp32)
DECLARE_KERNEL(ue3m5, ue3m5, fp16)
DECLARE_KERNEL(e3m4, e3m4, fp32)
DECLARE_KERNEL(e3m4, e3m4, fp16)
DECLARE_KERNEL(e3m3, e3m3, fp32)
DECLARE_KERNEL(e3m3, e3m3, fp16)
DECLARE_KERNEL(e3m2, e3m2, fp32)
DECLARE_KERNEL(e3m2, e3m2, fp16)
DECLARE_KERNEL(e3m1, e3m1, fp32)
DECLARE_KERNEL(e3m1, e3m1, fp16)
DECLARE_KERNEL(e3m0, e3m0, fp32)
DECLARE_KERNEL(e3m0, e3m0, fp16)
DECLARE_KERNEL(ue1m4, ue1m4, fp32)
DECLARE_KERNEL(ue1m4, ue1m4, fp16)
DECLARE_KERNEL(ue2m4, ue2m4, fp32)
DECLARE_KERNEL(ue2m4, ue2m4, fp16)
DECLARE_KERNEL(ue3m4, ue3m4, fp32)
DECLARE_KERNEL(ue3m4, ue3m4, fp16)
DECLARE_KERNEL(ue4m4, ue4m4, fp32)
DECLARE_KERNEL(ue4m4, ue4m4, fp16)
DECLARE_KERNEL(e4m3, e4m3, fp32)
DECLARE_KERNEL(e4m3, e4m3, fp16)
DECLARE_KERNEL(e4m2, e4m2, fp32)
DECLARE_KERNEL(e4m2, e4m2, fp16)
DECLARE_KERNEL(e4m1, e4m1, fp32)
DECLARE_KERNEL(e4m1, e4m1, fp16)
DECLARE_KERNEL(e4m0, e4m0, fp32)
DECLARE_KERNEL(e4m0, e4m0, fp16)
DECLARE_KERNEL(ue1m3, ue1m3, fp32)
DECLARE_KERNEL(ue1m3, ue1m3, fp16)
DECLARE_KERNEL(ue2m3, ue2m3, fp32)
DECLARE_KERNEL(ue2m3, ue2m3, fp16)
DECLARE_KERNEL(ue3m3, ue3m3, fp32)
DECLARE_KERNEL(ue3m3, ue3m3, fp16)
DECLARE_KERNEL(ue4m3, ue4m3, fp32)
DECLARE_KERNEL(ue4m3, ue4m3, fp16)
DECLARE_KERNEL(ue5m3, ue5m3, fp32)
DECLARE_KERNEL(ue5m3, ue5m3, fp16)
DECLARE_KERNEL(e5m2, e5m2, fp32)
DECLARE_KERNEL(e5m2, e5m2, fp16)
DECLARE_KERNEL(e5m1, e5m1, fp32)
DECLARE_KERNEL(e5m1, e5m1, fp16)
DECLARE_KERNEL(e5m0, e5m0, fp32)
DECLARE_KERNEL(e5m0, e5m0, fp16)
DECLARE_KERNEL(ue1m2, ue1m2, fp32)
DECLARE_KERNEL(ue1m2, ue1m2, fp16)
DECLARE_KERNEL(ue2m2, ue2m2, fp32)
DECLARE_KERNEL(ue2m2, ue2m2, fp16)
DECLARE_KERNEL(ue3m2, ue3m2, fp32)
DECLARE_KERNEL(ue3m2, ue3m2, fp16)
DECLARE_KERNEL(ue4m2, ue4m2, fp32)
DECLARE_KERNEL(ue4m2, ue4m2, fp16)
DECLARE_KERNEL(ue5m2, ue5m2, fp32)
DECLARE_KERNEL(ue5m2, ue5m2, fp16)
DECLARE_KERNEL(ue6m2, ue6m2, fp32)
DECLARE_KERNEL(ue6m2, ue6m2, fp16)
DECLARE_KERNEL(e6m1, e6m1, fp32)
DECLARE_KERNEL(e6m1, e6m1, fp16)
DECLARE_KERNEL(e6m0, e6m0, fp32)
DECLARE_KERNEL(e6m0, e6m0, fp16)
DECLARE_KERNEL(ue1m1, ue1m1, fp32)
DECLARE_KERNEL(ue1m1, ue1m1, fp16)
DECLARE_KERNEL(ue2m1, ue2m1, fp32)
DECLARE_KERNEL(ue2m1, ue2m1, fp16)
DECLARE_KERNEL(ue3m1, ue3m1, fp32)
DECLARE_KERNEL(ue3m1, ue3m1, fp16)
DECLARE_KERNEL(ue4m1, ue4m1, fp32)
DECLARE_KERNEL(ue4m1, ue4m1, fp16)
DECLARE_KERNEL(ue5m1, ue5m1, fp32)
DECLARE_KERNEL(ue5m1, ue5m1, fp16)
DECLARE_KERNEL(ue6m1, ue6m1, fp32)
DECLARE_KERNEL(ue6m1, ue6m1, fp16)
DECLARE_KERNEL(ue7m1, ue7m1, fp32)
DECLARE_KERNEL(ue7m1, ue7m1, fp16)
DECLARE_KERNEL(e7m0, e7m0, fp32)
DECLARE_KERNEL(e7m0, e7m0, fp16)
DECLARE_KERNEL(ue1m0, ue1m0, fp32)
DECLARE_KERNEL(ue1m0, ue1m0, fp16)
DECLARE_KERNEL(ue2m0, ue2m0, fp32)
DECLARE_KERNEL(ue2m0, ue2m0, fp16)
DECLARE_KERNEL(ue3m0, ue3m0, fp32)
DECLARE_KERNEL(ue3m0, ue3m0, fp16)
DECLARE_KERNEL(ue4m0, ue4m0, fp32)
DECLARE_KERNEL(ue4m0, ue4m0, fp16)
DECLARE_KERNEL(ue5m0, ue5m0, fp32)
DECLARE_KERNEL(ue5m0, ue5m0, fp16)
DECLARE_KERNEL(ue6m0, ue6m0, fp32)
DECLARE_KERNEL(ue6m0, ue6m0, fp16)
DECLARE_KERNEL(ue7m0, ue7m0, fp32)
DECLARE_KERNEL(ue7m0, ue7m0, fp16)
DECLARE_KERNEL(ue8m0, ue8m0, fp32)
DECLARE_KERNEL(ue8m0, ue8m0, fp16)
#endif
