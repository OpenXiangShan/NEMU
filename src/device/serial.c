...
void init_serial() {
  ...
  add_pio_map("serial", CONFIG_SERIAL_PORT, (uint8_t *)serial_base, 8, serial_io_handler);
  add_mmio_map("serial", CONFIG_SERIAL_MMIO, (uint8_t *)serial_base, 8, serial_io_handler);
