...
void init_disk() {
  ...
  add_pio_map ("disk", CONFIG_DISK_CTL_PORT, disk_base, space_size, MMIO_READ|MMIO_WRITE|MMIO_EXEC, disk_io_handler);
  add_mmio_map("disk", CONFIG_DISK_CTL_MMIO, disk_base, space_size, MMIO_READ|MMIO_WRITE|MMIO_EXEC, disk_io_handler);
