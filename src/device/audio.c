...
void init_audio() {
  ...
  add_pio_map ("audio", CONFIG_AUDIO_CTL_PORT, audio_base, space_size, MMIO_READ|MMIO_WRITE|MMIO_EXEC, audio_io_handler);
  add_mmio_map("audio", CONFIG_AUDIO_CTL_MMIO, audio_base, space_size, MMIO_READ|MMIO_WRITE|MMIO_EXEC, audio_io_handler);
